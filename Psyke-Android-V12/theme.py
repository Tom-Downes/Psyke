...
DESENS_1   = "#78d4ff"   # Low      — bright azure (least desensitized)
DESENS_2   = "#3898d8"   # Moderate — medium blue
DESENS_3   = "#1a5faa"   # High     — deep blue
DESENS_4   = "#0c3272"   # Extreme  — dark navy (most desensitized)

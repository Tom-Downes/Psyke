...
LOG_PATH="${SCRIPT_DIR}/buildozer-aab-v4.log"
OUT_DIR="${REPO_ROOT}/ABB"
OUT_FILE="${OUT_DIR}/ABB-V4.aab"
...
spec = upsert(spec, "android.api", "35")
...
print(f"Stamped version={version} numeric={numeric} api=35 sha={sha} run={run_no}")
PY

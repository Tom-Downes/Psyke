...
class FearsTab(MDBoxLayout):
    ...
    def _on_push(self, *_):
        ...
        if fear_cured:
            ...
            Clock.schedule_once(
                lambda _, r=new_rung, n=name: app.notify_event(
                    f"Desensitization: {n} -> {DESENS_NAMES[r]}",
    ...
    def _on_avoid(self, *_):
        ...
        Clock.schedule_once(
            lambda _, s=new_stage, n=name: app.notify_event(
                f"Severity: {n} -> {FEAR_STAGES[s].name}",

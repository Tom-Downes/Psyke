...
FEAR_RULES_TEXT = (
    ...
    "   DC = 10 base (rung adjusts: Rung 1=16, 2=14, 3=12, 4=10)\n"
...
MADNESS_RULES_TEXT = (
    ...
    "INSANITY TABLES: D20 named entries\n"
...
SPELL_RULES_TEXT = (
    ...
    "  insanity entry, OR cures one Minor Wound.\n\n"
    "MAJOR RESTORATION:\n"
    "  Removes one Indefinite insanity entry,\n"
    "  OR cures one Major Wound (also regenerates\n"
    "  lost body parts where applicable).\n\n"
    "Use the lists to select the specific\n"
    "insanity or wound to target before casting."
)
